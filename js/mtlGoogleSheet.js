...
(function(){
    ...
    .constant('configGoogleSheet',{
        ...
        urlDevApi : 'https://script.google.com/macros/s/AKfycbwu3LocW6IGJd8gZWh1brDzpeJnrDRa1w3Nov_4Pj9u/dev',
        urlExecApi : 'https://script.google.com/macros/s/AKfycbxXV9gFEcRud9gDadUR-xALse2wngrMFVakEVI4q2pKHhWT-cPt/exec'
    })
        ...
        googleSheet.request = function(params,callback){
            $http({url:_urlApi,
               ...
               callback(data.data, data.status, data.message);
                ...
                if(status === 404)
                   status = "<a href='"+_urlBaseApi+"'>Autorizar API</a>";
